...
const Home: React.FC = () => {
  return (
    <div className="mt-10 mb-10 md:mt-1 flex flex-col lg:flex-row md:flex-col md:gap-8 md:justify-center min-h-[65vh] md:min-h-[80vh] items-center p-4 animate-fadeIn">
      ...
      <div className="w-full lg:w-4/5 lg:w-2/3 flex flex-col justify-center animate-fadeInRight">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="p-4 h-56 relative rounded-lg border border-gray-700 bg-white bg-opacity-5 backdrop-blur-sm shadow-xl hover:shadow-2xl">
            <div>
              <ResumeCard />
            </div>
          </div>
