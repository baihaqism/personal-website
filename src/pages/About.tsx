...
import SkeletonLoader from "../components/card/SkeletonLoader";
    ...
    <div className="mt-10 md:mt-1 flex flex-col lg:flex-row md:flex-col md:gap-8 md:justify-center min-h-[65vh] md:min-h-[80vh] items-center p-4">
      ...
      <div className="w-full lg:w-4/5 lg:w-2/3 flex flex-col justify-center">
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <div className="p-4 h-56 group relative rounded-lg border border-gray-700 bg-white bg-opacity-5 backdrop-blur-sm shadow-xl shadow shadow-blue-500/40 transition duration-500 hover:shadow-indigo-500/40 hover:shadow-2xl">
            <div>
              <SkeletonLoader />
